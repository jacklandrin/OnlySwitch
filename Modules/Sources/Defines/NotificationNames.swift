...
public extension Notification.Name {
    ...
    static let desktopPetVisibilityChanged = Notification.Name("desktopPetVisibilityChanged")
    ...
    static let toggleSoundMixerItem = Notification.Name(rawValue: "toggleSoundMixerItem")
